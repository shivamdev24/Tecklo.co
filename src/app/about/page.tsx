    ...
    <div>
      <section className=" overflow-hidden h-80 relative">
        ...
        <div className="justify-center items-center flex flex-col gap-4 h-full px-5">
          ...
          <p className="text-base font-medium text-gray-600 text-center max-w-7xl mx-auto">
            where innovation meets diversity in the heart of Canada. We&apos;re
            not just a tech startup. we&apos;re the backbone of creativity and
            expertise, driven by a team of exceptional minds from all corners of
            the globe.
          </p>
        </div>
      </section>
      <section className="border-t py-10 px-5">
        <div className="max-w-7xl mx-auto flex flex-col gap-5">
          ...
          <p>
            <strong className="text-lg"> Our mission is simple:</strong> to turn
            your business needs into reality with the most effective technology
            solutions and a touch of brilliance. Our team is a blend of
            visionaries, engineers, designers, and strategists, each bringing
            their unique perspective and skill set to the table. This rich
            tapestry of backgrounds and experiences fuels our ability to tackle
          ...
          <p>
            ...
            ensure that every project benefits from a wealth of perspectives and
